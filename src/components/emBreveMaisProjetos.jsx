export function EmBreveMaisProjetos() {
    return (
        <div class="bg-zinc-700 w-[85%] text-center mt-16 py-16 mx-auto rounded-lg flex items-center justify-between flex-col gap-10 hover:bg-slate-600">
            <h3 className="text-blue-700 text-3xl self-center ">Em breve...</h3>
            <svg
